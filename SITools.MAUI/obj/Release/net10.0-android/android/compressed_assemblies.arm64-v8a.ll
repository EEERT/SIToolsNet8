...
@compressed_assembly_descriptors = dso_local local_unnamed_addr global [125 x %struct.CompressedAssemblyDescriptor] [
	...
	%struct.CompressedAssemblyDescriptor {
		...
		i1 false, ; bool loaded
		i32 12106120; uint32_t buffer_offset
	}, ; 122: Java.Interop
	%struct.CompressedAssemblyDescriptor {
		i32 22560, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 12277128; uint32_t buffer_offset
	}, ; 123: Mono.Android.Runtime
	%struct.CompressedAssemblyDescriptor {
		i32 2020352, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 12299688; uint32_t buffer_offset
	} ; 124: Mono.Android
], align 4

@uncompressed_assemblies_data_size = dso_local local_unnamed_addr constant i32 14320040, align 4

@uncompressed_assemblies_data_buffer = dso_local local_unnamed_addr global [14320040 x i8] zeroinitializer, align 1
